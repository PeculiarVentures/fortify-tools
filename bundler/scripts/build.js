...
measureFileSizesBeforeBuild(path.resolve(__dirname, `../../${env.raw.OUTPUT_FOLDER}`))
  ...
  .then((previousFileSizes) => {
    const config = require('../config/prod.config'); // eslint-disable-line
  ...
  .then(
    ({ stats, previousFileSizes, warnings }) => {
      ...
      printFileSizesAfterBuild(
        stats,
        previousFileSizes,
        path.resolve(__dirname, `../../${env.raw.OUTPUT_FOLDER}`),
