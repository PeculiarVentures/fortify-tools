...
export const APP_STATE_FROM_ROUTE = 'APP:STATE_FROM_ROUTE';
...
export const PROVIDER_SET_LIST = 'PROVIDER:SET_LIST';
...
export const WS_CREATE_SELF_SIGNED_CERTIFICATE = 'WS:SELF_SIGNED_CERTIFICATE';
...
export const WS_HANDLE_ACTION = 'WS:HANDLE_ACTION ';
export const WS_CONNECTION_READY = 'WS:CONNECTION_READY ';
export const WS_PROVIDER_LOGIN = 'WS:PROVIDER_LOGIN ';
export const WS_CONNECTION_CLOSE = 'WS:CONNECTION_CLOSE ';
