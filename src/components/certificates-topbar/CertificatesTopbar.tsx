...
interface ICertificatesTopbarProps {
...
> = (props) => {
  ...
  const renderCreateButton = () => {
    ...
    return (
      <Menu
        popoverProps={{ className: styles.creation_menu }}
        options={[
          {
  ...
  return (
    <div className={clsx(styles.topbar_root, className)}>
      <div className={styles.search_field}>
        ...
        <IconButton
          className={clsx(styles.clear_button, { ['hidden']: !searchValue })}
          size="small"
