...
interface ICertificateAlgorithmInfoProps {
...
export const CertificateAlgorithmInfo: React.FunctionComponent<
  ICertificateAlgorithmInfoProps
> = (props) => {
  const {
    className, algorithmSignature, algorithmHash,
  } = props;
  ...
  return (
    <div className={clsx(styles.algorithm_info, className)}>
      <Typography variant="c1" color="gray-9">
        {t('certificates.signature-algorithm')}
        :
        {algorithmSignature}
      </Typography>
      <Typography variant="c1" color="gray-9">
        {t('certificates.hash-algorithm')}
        :
        {algorithmHash}
      </Typography>
    </div>
